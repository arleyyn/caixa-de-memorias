      ...
      <nav className="row-start-1 row-end-2 z-30 mx-auto w-full max-w-6xl px-4 lg:px-6">
        <div className="flex h-14 items-center justify-between">
          <div className="select-none font-medium tracking-[0.2em] text-zinc-300">
            <span className="mr-2 text-[10px] align-super">◦</span>
            CAIXA·DE·MEMÓRIAS
            <span className="ml-2 text-[10px] align-super">◦</span>
          </div>
        </div>
      </nav>
        ...
        <div className="grid h-full w-full min-h-0 grid-cols-1 items-center gap-8 md:grid-cols-2">
          <div className="space-y-6">
            ...
            <p className="text-pretty text-base leading-relaxed text-zinc-200 md:text-lg">
              Nossa amizade já completa 5 anos, e nesse tempo vivemos juntos
              muitos momentos alegres, desafiadores, estressantes e até
              tristes. Tive o privilégio de compartilhar cada um deles ao seu
              lado, e por isso preparei uma
            ...
            <Link href="/hack" className="inline-block">
              <Button className="group border border-zinc-700 bg-zinc-950 hover:bg-zinc-900" size="lg">
